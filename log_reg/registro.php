	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="../php/registro_be.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Se requiere almenos 8 caracteres">
						<input class="input100" type="email" name="correo" placeholder="Email">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
