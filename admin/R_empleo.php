            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="funciones/reg_empleo.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">

                                    <div class="form-group">
                                        <label for="nameempresa">Nombre de la Empresa:</label>
                                        <input type="text" class="form-control" id="nameempresa" aria-describedby="title" placeholder="Empleatec" name="nombre_empresa">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" aria-describedby="title" placeholder="Contacto@empleatec.com" name="correo_empresa">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampletitle" aria-describedby="title" placeholder="Se necesita trabajador para..." name="titulo_anuncio">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="sueldo" placeholder="$20,000 MX" name="sueldo">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formadepago" placeholder="Mensualmente - Quincenal - Comisiones, Etc." name="pago">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactophone">Numero de Contacto:</label>
                                        <input type="number" class="form-control" id="contactophone" placeholder="9921324365" name="numero_contacto">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="vacantes" placeholder="2..." name="vacantes">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea" rows="3" name="description1"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea" rows="3" name="description2"></textarea>
                            ...
                            <button type="submit" class="btn btn-general btn-blue mr-2">Agregar</button>  
